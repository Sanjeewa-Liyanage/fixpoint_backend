...
class Inventory_Item extends Model{
   ...
   public function update(){
        $conn = DatabaseConnection::getConnection();
        $sql = "UPDATE inventory_item SET item_name = :item_name, category = :category, description = :description, manufacturer = :manufacturer, created_at = :created_at WHERE item_id = :item_id";
        $stmt = $conn->prepare($sql);
